...
class UserAppsControllerTest < ActionController::TestCase
  ...
  test "should create user_app" do
    assert_difference('UserApp.count') do
      post :create, user_app: { app_id: @user_app.app_id, description: @user_app.description, name: @user_app.name, user_id: @user_app.user_id }
    end
  ...
  test "should update user_app" do
    patch :update, id: @user_app, user_app: { app_id: @user_app.app_id, description: @user_app.description, name: @user_app.name, user_id: @user_app.user_id }
    assert_redirected_to user_app_path(assigns(:user_app))
  end
